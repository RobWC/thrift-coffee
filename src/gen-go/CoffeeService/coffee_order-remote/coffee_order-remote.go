...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  i32 orderCoffee(Coffee coffee)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := CoffeeService.NewCoffeeOrderClientFactory(trans, protocolFactory)
	...
	case "orderCoffee":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "OrderCoffee requires 1 args")
			flag.Usage()
		}
		arg8 := flag.Arg(1)
		...
		argvalue0 := CoffeeService.NewCoffee()
		...
		value0 := argvalue0
		fmt.Print(client.OrderCoffee(value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
